...
export default function FlowersPage() {
  ...
  // Si deseas prevenir clic derecho y ciertas teclas, puedes incluirlo en useEffect
  useEffect(() => {
  ...
  // Al hacer clic en cualquier parte del sobre, redirige a "/formulario"
    ...
    <>
      ...
      <style jsx global>{`
        ...
        *,
        ...
        .envelope:hover .envelope-back .top-fold {
          transform: var(--fold-rotate-hover);
        }
        .letter {
          position: absolute;
          bottom: 5px;
      ...
      `}</style>
      {/* Al agregar onClick en el contenedor principal, cualquier clic redirige a la página de formulario */}
      <div className="envelope" onClick={() => router.push('/formulario')}>
        <div className="envelope-inner">
          <div className="envelope-front">
            ...
            <div className="address">
              <p>
                <span>De:</span> <span>Tony Chen</span>
              </p>
              <p>
                <span>Para:</span> <span>Martina Constante</span>
              </p>
            </div>
          </div>
          <div className="envelope-back">
            ...
            <div className="letter">
              ...
              />
              <p>
                Holis! Esta es una invitacion a una cita de San Valentin <span className="highlight">Aceptas?</span>
              </p>
              <img
              ...
              />
              <p className="final-message">¡Gracias por confirmar la cita!</p>
            </div>
          </div>
        </div>
      </div>
